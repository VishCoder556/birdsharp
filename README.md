...
2. **Parsing Modes** (e.g., `#!flat`)
    * These alter how the source code is parsed into an Abstract Syntax Tree (AST).
3. **Typechecking / Revising Modes** *(`#!autovar`)*
    * These are designed to modify small details about ASTs, including manual optimization toggles, or changes to the typeinfo of a variable or function. 
